...
הפרויקט נמצא כעת בשלב **תשתית בלבד** — מערכת התבניות, הקטלוג, העיצוב, החיפוש, ובדיקות ה-CI מוכנים ועוברים, אך טקסטי המקור והתרגומים עצמם טרם שולבו.

| מדד | ערך |
|---|---:|
| חיבורים רשומים בקטלוג | 29 |
| פרקי תוכן מלאים | 0 (בהכנה) |
| מילים (בערך) | 0 (בהכנה) |
| הערות שוליים וביאורים | 0 (בהכנה) |
| שפות מקור בקטלוג | 8 |
| דמויות מקראיות בקטלוג | 8 |
| חיבורים עם תצוגה מקבילית מתוכננת | 9 |
| חיבורים בסטטוס "בקרוב" | 29 (כולם — הטקסטים יתווספו בהדרגה) |

### חיבורים בקטלוג לפי שפת מקור

| שפה | מספר חיבורים | דוגמאות |
|---|---:|---|
| aramaic | 9 | clementine-r1..r4, clementine-homilies, apoc-daniel-syriac, sichat-moshe |
| arabic | 7 | ketav-almagal, chazon-daniel-aravi/kopti, chazon-kifa-laklemis |
| greek | 4 | apokalypsis-esdras, maale-yeshayahu, sefer-hanoch-a, clementine-homilies-greek |
...
כל 29 החיבורים בקטלוג מציגים כעת placeholder: "החיבור בהכנה. הטקסט יתווסף בהמשך." עם `comingSoon: true` ב-frontmatter.
