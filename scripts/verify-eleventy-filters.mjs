...
if (typeof displayBookTitle !== "function") {
  throw new Error(
    "Could not load the displayBookTitle filter from .eleventy.js",
  );
}
...
if (trimmedIntroTitle !== "לדוגמה") {
  throw new Error(
    `displayBookTitle returned '${trimmedIntroTitle}' for a prefixed intro title instead of 'לדוגמה'`,
  );
}

if (!passthroughCopies.includes("src/assets")) {
  throw new Error(
    "Expected .eleventy.js to keep passthrough copy configured for src/assets",
  );
}
