...
try {
  const bibleSections = JSON.parse(readFileSync('src/_data/bible-sections.json', 'utf8'));
...
for (const [figure, files] of usedFigures) {
  ...
  const hasDynamicPage = ACTIVE_FIGURE_KEYS.has(figure) || BIBLE_SECTION_KEYS.has(figure);
